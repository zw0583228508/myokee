...
const he: UITranslations = {
  ...
  jobPage: {
    ...
    freeUnder40: "חינם (עד 90 שניות)", creditsUsed: "קרדיטים שנוצלו", creditsUnit: "קרדיטים",
    ...
    toastFreeTitle: "שיר חינמי!", toastFreeDesc: "שיר קצר מ-90 שניות — ללא עלות.",
  ...
  sing: {
    ...
    premiumRequired: "נדרש מנוי בתשלום", premiumRequiredDesc: "כדי לשיר ולהקליט מעל הפלייבק, צריך מנוי בתשלום או רכישת קרדיטים", upgrade: "שדרג עכשיו", maybeLater: "אולי בפעם אחרת",
  },
};
...
const en: UITranslations = {
  ...
  jobPage: {
    ...
    freeUnder40: "Free (under 90 seconds)", creditsUsed: "Credits Used", creditsUnit: "credits",
    ...
    toastFreeTitle: "Free song!", toastFreeDesc: "Song under 90 seconds — no charge.",
  ...
  sing: {
    ...
    premiumRequired: "Paid Subscription Required", premiumRequiredDesc: "To sing and record over the playback, you need a paid subscription or credits", upgrade: "Upgrade Now", maybeLater: "Maybe Later",
  },
};
...
const ar: UITranslations = {
  ...
  jobPage: {
    ...
    freeUnder40: "مجاني (أقل من 90 ثانية)", creditsUsed: "الرصيد المستخدم", creditsUnit: "رصيد",
    ...
    toastFreeTitle: "أغنية مجانية!", toastFreeDesc: "أغنية أقل من 90 ثانية — بلا رسوم.",
  ...
  sing: {
    ...
    premiumRequired: "يتطلب اشتراكاً مدفوعاً", premiumRequiredDesc: "للغناء والتسجيل فوق الموسيقى، تحتاج إلى اشتراك مدفوع أو رصيد", upgrade: "ترقية الآن", maybeLater: "ربما لاحقاً",
  },
};
...
const ru: UITranslations = {
  ...
  jobPage: {
    ...
    freeUnder40: "Бесплатно (до 90 секунд)", creditsUsed: "Использовано кредитов", creditsUnit: "кредитов",
    ...
    toastFreeTitle: "Бесплатная песня!", toastFreeDesc: "Песня короче 90 секунд — бесплатно.",
  ...
  sing: {
    ...
    premiumRequired: "Требуется платная подписка", premiumRequiredDesc: "Чтобы петь и записывать поверх фонограммы, нужна платная подписка или кредиты", upgrade: "Обновить сейчас", maybeLater: "Может быть позже",
  },
};
...
const es: UITranslations = {
  ...
  jobPage: {
    ...
    freeUnder40: "Gratis (menos de 90 segundos)", creditsUsed: "Créditos usados", creditsUnit: "créditos",
    ...
    toastFreeTitle: "¡Canción gratis!", toastFreeDesc: "Canción menor a 90 segundos — sin costo.",
  ...
  sing: {
    ...
    premiumRequired: "Se requiere suscripción de pago", premiumRequiredDesc: "Para cantar y grabar sobre la pista, necesitas una suscripción de pago o créditos", upgrade: "Actualizar ahora", maybeLater: "Quizás más tarde",
  },
};
...
const vi: UITranslations = cloneWithLang(en, {
  ...
  sing: { ...en.sing, readyToSing: "Sẵn sàng hát chưa?", startBtn: "Bắt đầu", micVolume: "Âm lượng mic", backingVolume: "Âm lượng nhạc nền (tai nghe)", vocalEffects: "Hiệu ứng giọng hát", resetDefaults: "Đặt lại mặc định", micUnavailable: "Mic không khả dụng", points: "điểm", pitchAccuracy: "Độ chính xác cao độ", timing: "Nhịp", stability: "Độ ổn định", wordsLabel: "Từ", expression: "Biểu cảm", artistComparison: "So sánh với ca sĩ gốc", bestMoment: "Khoảnh khắc tuyệt nhất", recordAgain: "Thu âm lại 🎤", shareResult: "Chia sẻ kết quả", challengeFriend: "Thách đấu bạn bè 🏆", singAgain: "Hát lại", challengeWin: (name) => `🏆 Bạn đã thắng ${name}!`, challengeLose: (name) => `😤 ${name} vẫn dẫn trước...`, shareTextWithScore: (song, score) => `Tôi hát "${song}" trên MYOUKEE và được ${score}/100! 🎤 Bạn thử đi!`, shareTextNoScore: (song) => `Tôi đã biến "${song}" thành karaoke trên MYOUKEE!`, someoneDefault: "Ai đó", premiumRequired: "Cần đăng ký trả phí", premiumRequiredDesc: "Để hát và thu âm trên nhạc nền, bạn cần đăng ký trả phí hoặc credits", upgrade: "Nâng cấp ngay", maybeLater: "Để sau" },
});
...
const tl: UITranslations = cloneWithLang(en, {
  ...
  sing: { ...en.sing, readyToSing: "Handa ka na bang kumanta?", startBtn: "Simulan", micVolume: "Volume ng Mic", backingVolume: "Volume ng Backing (earphones)", vocalEffects: "Mga Vocal Effect", resetDefaults: "I-reset sa default", micUnavailable: "Hindi available ang mic", points: "puntos", pitchAccuracy: "Pitch Accuracy", timing: "Timing", stability: "Stability", wordsLabel: "Lyrics", expression: "Expression", artistComparison: "Paghahambing sa Original Artist", bestMoment: "Pinakamahusay mong sandali", recordAgain: "Mag-record ulit 🎤", shareResult: "I-share ang Resulta", challengeFriend: "Hamunin ang Kaibigan 🏆", singAgain: "Kumanta Ulit", challengeWin: (name) => `🏆 Tinalo mo si ${name}!`, challengeLose: (name) => `😤 Nangunguna pa rin si ${name}...`, shareTextWithScore: (song, score) => `Kumanta ako ng "${song}" sa MYOUKEE at nakakuha ng ${score}/100! 🎤 Kaya mo ba?`, shareTextNoScore: (song) => `Ginawa kong karaoke ang "${song}" sa MYOUKEE!`, someoneDefault: "Isang tao", premiumRequired: "Kailangan ng Bayad na Subscription", premiumRequiredDesc: "Para makakanta at makapag-record sa playback, kailangan mo ng bayad na subscription o credits", upgrade: "Mag-upgrade na", maybeLater: "Mamaya na lang" },
});
