...
export const PARTY_LANGS: Record<SupportedLang, PartyTranslations> = {
  ...
  ja: {
    ...
    room: {
      partyCode: "パーティーコード", shareCode: "コードを共有", copied: "コピー完了！", scanQr: "QRをスキャン", guests: "ゲスト", queue: "曲順", leaderboard: "ランキング", settings: "設定", addSong: "曲を追加", addToQueue: "キューに追加", songName: "曲名", songNamePlaceholder: "曲名を入力...", nowSinging: "現在歌唱中", upNext: "次の曲", emptyQueue: "キューが空です", emptyQueueHint: "曲を追加しましょう！", nextSong: "次の曲へ", endParty: "パーティー終了", endPartyConfirm: "本当に終了しますか？", yes: "はい", no: "いいえ", host: "ホスト", guest: "ゲスト", waiting: "待機中", singing: "歌唱中", done: "完了", remove: "削除", you: "あなた", members: "メンバー", noMembers: "まだメンバーがいません", changeTheme: "テーマ変更", solo: "ソロ", duet: "デュエット", battle: "バトル", selectMode: "モード選択", duetPartner: "デュエットパートナー", selectPartner: "パートナーを選択", liveDisplay: "ライブディスプレイ", openDisplay: "大画面で表示", shareParty: "共有", shareMessage: "MYOUKEEのカラオケパーティーに参加しよう！コード：{code}",
    },
